...
$constantes = new Constantes(
    [
        ...
        'VERSION_CSS' =>  constant("ENV") == "prod" ? 588 : time(),
        'VERSION_JS' =>  constant("ENV") == "prod" ? 580 : time(), // Permet de recharger le fichier javascript sans vider le cache
        'VERSION_JS_BACK' => constant("ENV") == "prod" ? 561 : time(), //Permet de forcer les js en cache du client
        'VERSION_JS_FRONT' => constant("ENV") == "prod" ? 561 : time(), //Permet de forcer les js en cache du client
